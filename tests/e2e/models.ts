...
export const PROVIDER_MODELS = {
    anthropic: {
        ...
        contextWindow: ANTHROPIC_TEST.model.params.contextWindow,
    ...
    openai: {
        ...
        contextWindow: OPENAI_TEST.model.params.contextWindow,
    ...
    google: {
        ...
        contextWindow: GOOGLE_TEST.model.params.contextWindow,
